...
public class AutoCompleteDictionaryTrie implements Dictionary, AutoComplete {
	...
	/*
	 * For debugging public void printTree() { printNode(root); } public void
	 * printNode(TrieNode curr) { if (curr == null) return;
	 * 
	 * System.out.println(curr.getText());
	 * 
	 * TrieNode next = null; for (Character c : curr.getValidNextCharacters()) {
	 * next = curr.getChild(c); printNode(next); } }
	 */
}